...
const headline = ref(headlineField?.value || '');
...
v-model="headline" label="Headline" input-name="Headline" placeholder="Headline"
        input-type="text" class="w-full" />
    <div class="bg-gray-50 px-4 py-3 sm:flex sm:flex-row justify-end">
        <button
ref="cancelButtonRef"
            type="button"
            class="mt-3 p-4 inline-flex w-full justify-center rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 sm:mt-0 sm:w-auto" @click="closeModal">Cancel</button>
        <button
type="button"
