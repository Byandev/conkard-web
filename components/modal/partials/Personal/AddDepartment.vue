...
const { addDepartmentField, departmentField } = useNewCardStore();

const departmentName = ref(departmentField?.value || "");

const saveDepartmentFields = () => {
  const departmentFields = {
    value: departmentName.value,
  };
  addDepartmentField(departmentFields);
  closeModal();
};
...
<template>
  <FloatingLabelTextarea v-model="departmentName" label="Department" input-name="department" placeholder="Department"
